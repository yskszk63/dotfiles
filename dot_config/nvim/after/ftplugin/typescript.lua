-- https://github.com/denoland/deno/issues/28794#issuecomment-2888221811
-- https://github.com/onion108/onion27-nvim-config/blob/a79cf9d5852561f12bc91147b6b6a0d7e455dad8/lua/terminal/tweaks/deno-lsp-correction.lua
local function virtual_text_document(params)
  ...
  vim.bo[bufnr].modifiable = true -- ADD
